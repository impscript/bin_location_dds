...
import { Search, Package, Box, LogOut, Home, ClipboardList, ScanLine, Settings, Shield, Warehouse, Calculator, Gift, Truck, FileText } from 'lucide-react';
...
const Layout = () => {
    ...
    const bottomNavItems = [
        ...
        { path: '/premium-memos', icon: Gift, label: 'ใบเบิก' },
        { path: '/do', icon: FileText, label: 'ใบส่งสินค้า' },
